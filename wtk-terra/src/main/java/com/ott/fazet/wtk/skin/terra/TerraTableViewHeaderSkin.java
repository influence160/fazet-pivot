...
import com.ott.fazet.wtk.*;
import com.ott.fazet.wtk.TableViewHeader.SortMode;
...
public class TerraTableViewHeaderSkin extends ComponentSkin
    ...
    public int getPreferredWidth(int height) {
        ...
        if (tableView != null) {
            preferredWidth = TerraFazetTableViewSkin.getPreferredWidth(tableView,
    ...
    public int getBaseline(int width, int height) {
        ...
        if (tableView != null) {
            ArrayList<Integer> headerWidthsLocal = TerraFazetTableViewSkin.getColumnWidths(tableView, width);
    ...
    public void layout() {
        ...
        if (tableView != null) {
            headerWidths = TerraFazetTableViewSkin.getColumnWidths(tableView, getWidth());
        } else {
            headerWidths = null;
        }
    }
