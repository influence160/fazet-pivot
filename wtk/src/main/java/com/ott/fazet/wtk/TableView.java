...
import com.ott.fazet.wtk.content.*;
...
public abstract class TableView extends Component {
	...
	public enum SelectMode {
        ...
        /**
         * A single cell may be selected at a time.
         */
        
        SINGLECELL,
        /**
         * Multiple cells may be concurrently selected.
         */
        MULTICELLS,
        /**
         * A single column may be selected at a time.
         */
        
        SINGLECOLUMN,
        /**
         * Multiple columns may be concurrently selected.
         */
        MULTICOLUMNS
    ...
    protected static class OtTableViewSelectionListenerList extends WTKListenerList<FazetTableViewSelectionListener>
        implements FazetTableViewSelectionListener {
        @Override
		...
		public void selectedCellChanged(FazetTableView tableView,
	        ...
	        for (FazetTableViewSelectionListener listener : this) {
	            listener.selectedCellChanged(tableView, previousSelectedCell);
	        }
		}
    ...
    protected ColumnSequence columnSequence = new ColumnSequence();
    ...
    protected OtTableViewSelectionListenerList tableViewSelectionListeners = new OtTableViewSelectionListenerList();
     ...
     */
    public abstract void setSelectedCell(int columnIndex, int rowIndex) ;
     ...
     * @param end
     */
    public abstract void setSelectedPerimeter(Span x, Span y);
    ...
    public ImmutableList<Rectangle> getSelectedPerimeters() {
    	return perimeterSelection.getSelectedPerimeters();
    }
     ...
     * The ranges that were actually set.
     */
    public abstract Sequence<Rectangle> setSelectedPerimeters(ArrayList<Rectangle> selectedPerimeters);
     ...
     *
     * @param columnIndex
     * The column index of the cell whose selection state is to be tested.
     * @param rowIndex
     * The row index of the cell whose selection state is to be tested.
     *
     * @return <tt>true</tt> if the cell is selected; <tt>false</tt>,
     * otherwise.
     */
    public abstract boolean isCellSelected(int columnIndex, int rowIndex);
    ...
    /**
     * Returns the disabled state of a given cell.
     *
     * @param columnIndex
     * The column index of the cell whose disabled state is to be tested.
     * @param rowIndex
     * The row index of the cell whose disabled state is to be tested.
     * @return
     * <tt>true</tt> if the cell is disabled; <tt>false</tt>,
     * otherwise.
     */
    @SuppressWarnings("unchecked")
    public abstract boolean isCellDisabled(int columnIndex, int rowIndex);
    ...
    public ListenerList<FazetTableViewSelectionListener> getTableViewSelectionListeners() {
